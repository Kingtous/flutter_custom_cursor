...
class FlutterCustomCursors {
  ...
  static const MouseCursor pencil = FlutterCustomCursor(
      path: "packages/flutter_custom_cursor/assets/cursors/pencil.png",
      x: 1,
      y: 15);
  ...
  static MouseCursor getCustomCursor(String path,
      {double x = 1, double y = 8}) {
    return FlutterCustomCursor(path: path, x: 1, y: 8);
  }
}
